...
const cardData = [
  {
    ...
    overlay: <>Relax in Style <span className="text-[#bb8d48] group-hover:text-[#fff]">Recliner</span></>,
    desc: "Arvana Motorized R3 Rocking Revolving 1 Seater Recliner in Suede Fabric (Grey)",
  },
  {
    video: "/video/v2.mp4",
    poster: "/Images/5.jpeg",
    overlay: <>Brand Story <span className="text-[#bb8d48] group-hover:text-[#fff]">Wooden Street</span></>,
    desc: "Furniture...bonded with love. 85+ Experience Stores, 20 Lakh+ Customers.",
  },
  {
    video: "/video/v4.mp4",
    poster: "/Images/7.jpeg",
    overlay: <>It&apos;s the Iriana Cane <span className="text-[#bb8d48] group-hover:text-[#fff]">multipurpose</span></>,
    desc: "Iriana Sheesham wood Cabinets and Sideboard (Walnut Finish)",
  },
  {
    video: "/video/v5.mp4",
    poster: "/Images/8.jpeg",
    overlay: <>Sofa Bed <span className="text-[#bb8d48] group-hover:text-[#fff]">with Storage</span></>,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {cardData.map((card, idx) => (
            <div
              key={idx}
              ref={cardRefs[idx]}
              className="bg-[#fff]/80 border-2 border-[#bfa76a] rounded-xl shadow-lg overflow-hidden flex flex-col backdrop-blur-md transition-all duration-300 group hover:shadow-[0_0_32px_8px_rgba(187,141,72,0.35)] hover:border-[#bb8d48] hover:bg-white/60 hover:backdrop-blur-xl cursor-pointer"
