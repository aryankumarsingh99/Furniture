  ...
  <section className="w-full max-w-[2200px] mx-auto flex flex-col lg:flex-row gap-6 items-stretch justify-center py-16 md:py-28 px-2 md:px-8 min-h-[850px] bg-[#f8fafc]">
    ...
    >
      ...
      <div className="relative z-10 p-10 flex flex-col justify-end h-full"  >
        <div className="text-lg font-medium text-[#ffffff] mb-2">Luxury Sofas</div>
        <div className="text-5xl font-serif font-bold text-[#ffffff] mb-2">SOFA SALE</div>
        <div className="text-2xl font-semibold text-[#bfa76a] mb-4">Comfort Redefined</div>
    ...
    <div className="flex flex-col gap-6 flex-1 w-full sm:max-w-2xl mx-auto lg:mx-0">
      ...
      >
        ...
        <div className="relative z-10 p-6 flex flex-col justify-end h-full"  >
          <div className="text-xl font-semibold text-[#ffffff] mb-1">Sectional Sofas</div>
          <div className="text-sm text-[#bfa76a] mb-1">Flexible Comfort for Every Room</div>
      ...
      >
        ...
        />
        <div className="relative z-10 p-6 flex flex-col justify-end h-full"  >
          <div className="text-xl font-semibold text-[#ffffff] mb-1">Sleeper Sofas</div>
          <div className="text-sm text-[#bfa76a] mb-1">Day to Night Comfort</div>
          <div className="text-base text-[#bfa76a] font-semibold flex items-center gap-2">
